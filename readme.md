...
### Create working directories from autopve docker container then use podman run to start this container (vs docker compose from link above), then open the host firewall to allow this traffic
```
